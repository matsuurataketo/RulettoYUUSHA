...
{
    //インスタンス化する座標
    [SerializeField, Header("ルーレット表示座標")] private Transform imageParentTransform;

    //複製したtextの文字書き換え用
    [Header("ルーレット種類")] public List<string> choices;
    ...
    //EnemyControllerアッタッチされているオブジェクト
    [SerializeField, Header("EnemyRouletteがアタッチされているオブジェクト")] private EnemyRoulette rController;

    [Header("ルーレットの分割数")] public float ratePerRoulette;
